    ...
    <footer className="footer-section">
      <div className="footer-head">
        ...
        <div className="grid grid-cols-2 gap-6 footer-menu">
          <ul>
            ...
            <li><a href="#" className="hover:text-pink-400">Design Talks</a></li>
            <li><a href="#" className="hover:text-pink-400">Sand Saga</a></li>
            <li><a href="#" className="hover:text-pink-400">Media</a></li>
            <li><a href="#" className="hover:text-pink-400">Events</a></li>
            <li><a href="#" className="hover:text-pink-400">Join Our Tribe</a></li>
          </ul>

          <ul>
            <li><a href="#" className="hover:text-pink-400">Sands Academy</a></li>
            <li><a href="#" className="hover:text-pink-400">Vrindavan</a></li>
            <li><a href="#" className="hover:text-pink-400">Shivaloca</a></li>
            <li><a href="#" className="hover:text-pink-400">Design Meetups</a></li>
            <li><a href="#" className="hover:text-pink-400">Xpsoure</a></li>
      ...
      <div className="footer-bottom">
        ...
        <div className="social-icons">
          <ul>
            <li>
              <a href="https://www.linkedin.com/company/sandcup?originalSubdomain=in" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlSpace="preserve"
                  width="25"
            ...
            <li>
              <a href="https://www.instagram.com/sandcupstudio/?hl=en" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlSpace="preserve"
                  width="30"
            ...
            <li>
              <a href="mailto:hr@sandcupstudio.com" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlSpace="preserve"
                  width="30"
    ...
    <div className="relative bg-[#E9F000] overflow-hidden py-2">
      ...
      <div className="whitespace-nowrap flex animate-scroll">
        <span className="font-semibold text-black text-base mx-4">
          TRIBE HAI TO VIBE HAI / VIBE WITH THE DESIGN TRIBE / TRIBE HAI TO VIBE HAI / VIBE WITH THE DESIGN TRIBE /           TRIBE HAI TO VIBE HAI / VIBE WITH THE DESIGN TRIBE / TRIBE HAI TO VIBE HAI / VIBE WITH THE DESIGN TRIBE /
